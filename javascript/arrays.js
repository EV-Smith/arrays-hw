//create an array
var colorList = ["Red", "Orange", "Yellow", "Green", "Blue", "Purple", "Pink", "Black", "White"];
...
//create the buildThumbs function
function buildThumbs()
{
  ...
  var output = "";
  //first part: counter - set up 0 to start counting the loop
